...
output: 
  beamer_presentation: 
    ...
    slide_level: 2
    toc: false
    keep_tex: yes    # uncomment to keep tex file in output directory; I have stopped tracking this file in the git repo.
    includes:
...
# options(tinytex.engine_args = '--output-directory=..')  # almost worked, but produced errors
