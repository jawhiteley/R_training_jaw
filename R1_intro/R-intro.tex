...
\begin{column}{0.3\textwidth}
Text with
\VERB|\FunctionTok{print}\NormalTok{(}\StringTok{"inline code"}\NormalTok{)}|.
\end{column}
...
\begin{frame}[fragile]{\(\includegraphics[height=1em]{C:/PROGRA~1/R/R-41~1.3/doc/html/logo.jpg}\)
is a show-off (2)}
\protect\hypertarget{includegraphicsheight1emcprogra1rr-411.3dochtmllogo.jpg-is-a-show-off-2}{}
\begin{columns}[T]
...
\texttt{R}{} will not only~ show the output, but also~ \emph{the code
used to produce it}.
\end{block}
\end{column}
\end{columns}
