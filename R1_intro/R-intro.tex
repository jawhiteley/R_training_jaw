...
%\setlength{\itemsep}{0.5\topsep}
%\setlength{\OuterFrameSep}{4pt}  % = \topsep by default in `framed` package
\newcommand{\Rlogo}{\includegraphics[height=1em]{C:/PROGRA~1/R/R-41~1.3/doc/html/logo.jpg}}
\newcommand{\R}{\texttt{R}}
\newcommand{\ctop}{\vspace{\topsep}}  % for aligning text with the top of a code block in a table (0.2\baselinesep seems like a good approximation; '\topsep+\parskip+\partopsep' seems logical, but might be too much, if it loses the rubber values)
...
\texttt{\textbackslash{}topsep}: \(\the\topsep\) \hfill
...
\item
  ...
  \href{https://www.r-project.org}{\(\includegraphics[height=1em]{C:/PROGRA~1/R/R-41~1.3/doc/html/logo.jpg}\)}\footnote<.->{The
    R logo
...
\item
  ...
  \end{itemize}
\item
  \textbf{\(\texttt{R}\)} was created by \uline{\textbf{R}}oss Ihaka and
  \uline{\textbf{R}}obert Gentleman --- aka ``R \& R''\footnote<.->{\url{https://www.r-project.org/contributors.html}}
...
\(\includegraphics[height=1em]{C:/PROGRA~1/R/R-41~1.3/doc/html/logo.jpg}\)}
\protect\hypertarget{interacting-with-includegraphicsheight1emcprogra1rr-411.3dochtmllogo.jpg}{}
\begin{itemize}
\item
  ...
  \tightlist
  \item
    aka a \uline{c}ommand \uline{l}ine \uline{i}nterface (cli)
  \item
...
offers suggestions}
\protect\hypertarget{includegraphicsheight1emcprogra1rr-411.3dochtmllogo.jpg-offers-suggestions}{}
...
\begin{frame}[fragile]{\(\includegraphics[height=1em]{C:/PROGRA~1/R/R-41~1.3/doc/html/logo.jpg}\)
is case-sensitive}
\protect\hypertarget{includegraphicsheight1emcprogra1rr-411.3dochtmllogo.jpg-is-case-sensitive}{}
\begin{longtable}[]{@{}
...
\begin{verbatim}
Error in try(Fail) : object 'Fail' not found
\end{verbatim}
