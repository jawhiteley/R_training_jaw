...
\begin{columns}[T,onlytextwidth]
\begin{column}{0.48\textwidth}
Two common solutions: 1. \VERB|\FunctionTok{round}\NormalTok{()}|
decimal values when comparing them 2. use a function with a tolerance
for small differences, such as
