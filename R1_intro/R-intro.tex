...
\hfill\break
\emph{Read more about \(\texttt{R}\)'s history on
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth,height=\textheight]{images/R-screenshot-win-plot.png}
\caption{screenshot of R GUI}
\end{figure}
\end{frame}
...
\note{Other training materials and tutorials:
