...
\begin{frame}{A quick tour of `base \(\texttt{R}\)'}
\protect\hypertarget{a-quick-tour-of-base-textttr}{}
\(\includegraphics[height=1em]{/Library/Frameworks/R.framework/Resources/doc/html/logo.jpg}\)
\end{frame}
...
\begin{itemize}
\item
  Regardless of the interface, you interact with \(\texttt{R}\)
  primarily using a \emph{command line}
...
R is designed so that users can start by using it \emph{interactively}
(what we will do today), and then gradually use it for more programming
as their needs and skills grow.
\end{frame}
...
\(\includegraphics[height=1em]{/Library/Frameworks/R.framework/Resources/doc/html/logo.jpg}\)
command-line (cont'd)}
\protect\hypertarget{the-includegraphicsheight1emlibraryframeworksr.frameworkresourcesdochtmllogo.jpg-command-line-contd}{}
\begin{itemize}
\item
