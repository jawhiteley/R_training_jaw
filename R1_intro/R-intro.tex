...
\newcommand{\ctop}{\vspace{\ifdim\OuterFrameSep=\maxdimen \topsep \else \OuterFrameSep \fi}}  % for aligning text with the top of a code block in a table (0.2\baselinesep seemed like a good approximation, depending on other parametes; '\topsep+\parskip+\partopsep' seemed logical, but might be too much, maybe because it loses the rubber values)
...
\end{Shaded}
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
\vspace{\ifdim\OuterFrameSep=\maxdimen \topsep \else \OuterFrameSep \fi}{}
