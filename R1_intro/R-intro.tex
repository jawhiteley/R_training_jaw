...
\item
  You may have to select a ``CRAN mirror'' (server) to use.
\end{itemize}
...
\begin{verbatim}
Installing package into '/Users/jaw/Library/R/arm64/4.3/library'
