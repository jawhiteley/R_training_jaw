...
![What is this?\
© [John Speirs/Comedywildlifephoto.com](https://www.comedywildlifephoto.com/gallery/comedy-wildlife-2021-competition-winners.php)](images/john-speirs_i-guess-summers-over.jpg){width=100%}
...
* Get familiar with the ![]( `r file.path(R.home("doc"), "html", "logo.jpg")`){height=1em}[^Rlogo] *interface*
...
\centering
\begin{tikzpicture}
  \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.9\textwidth]{images/R-screenshot-win-plot.png}};
  \begin{scope}[x={(image.south east)},y={(image.north west)}]
    \draw[ultra thick, rounded corners, draw=red, fill=white, fill opacity=0.5] (0,0.15) rectangle (0.54,0.87);
    \node[align=center, font=\Large\bfseries] at (0.27,0.30) {console};
    \draw[ultra thick, rounded corners, draw=red, fill=white, fill opacity=0.5] (0.4,0.02) rectangle (0.8,0.82);
    \node[align=center, font=\Large\bfseries] at (0.65,0.42) {plot\\ window};
  \end{scope}
\end{tikzpicture}
...
![$\R$ offers suggestions of commands to try in the console when it starts.](images/R-screenshot-win-default.png){width=90%}
