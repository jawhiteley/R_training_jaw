...
\highlightAlt{Note that \R{} will not only\\ 
...
- With the cursor next to the empty prompt (\OtherTok{\texttt{>}}),  
  use the up & down \highlight{arrow keys} (&uarr;&darr;) to
  re-produce previous commands
- This lets you 
  “scroll through your *command history*”
- Press \highlight{up} (\highlight{$\uparrow$}) once, and you get the last command you entered 
