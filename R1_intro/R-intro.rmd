...
header-includes: |
  ...
  %\setlength{\parskip}{\baselineskip}   % incease space between regular paragraphs, without affecting _compact_ lists: "lazy" lists are affected (each item is a paragraph?)
