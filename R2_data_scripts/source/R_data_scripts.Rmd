...
<!--
## **Activity **: `summarize()`{.r} data frames
...
## **Activity **: reshape data with the `tidyr` package
...
## **Activity **: write data to files with the `readr` package
...
## **Activity **: combine data frames with 2-table `dplyr` verbs
