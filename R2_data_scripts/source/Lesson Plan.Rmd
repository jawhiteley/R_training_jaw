...
4.  Scripts
    ...
    2.  Housekeeping: rm(list=ls())
    3.  open a script for the workshop code
    4.  Run code from the script
    5.  **Activity: readxl** in a script [need info on options, check results]
