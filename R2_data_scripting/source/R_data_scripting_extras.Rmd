...
<!--
- BOM & Microsoft Excel^TM^
- How to add a BOM character to the beginning of a csv file (if you really have to)
- How a BOM character affects functions like read.csv() & read_csv()
- Bottom line: using `readr` keeps everything in UTF-8 by default, and ignores BOM if present (easiest)
-->
