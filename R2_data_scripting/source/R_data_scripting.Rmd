...
## Exercise 1: what's wrong with this data {.shrink}
...
- The `PlantNum` column does not contain the original
  unique identifier in `Plant`
...
_There are other differences you may have noticed:
 we'll look at other ways to identify these automatically later._
