...
\item
  ...
  provides a ``forward-pipe operator''\footnote<.->{Although it is a
    `pipe' operator, it does not contain a `pipe' character
    (\texttt{\textbar{}}), hence the reference to René Magritte's
    surrealist painting.}:
