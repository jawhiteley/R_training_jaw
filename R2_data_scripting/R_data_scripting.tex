...
\begin{itemize}
\item
  The \href{https://www.tidyverse.org/}{\texttt{tidyverse}} is actually
  an ``opinionated''
  \href{https://www.tidyverse.org/packages/}{collection of packages}
...
\item
  ...
  \href{https://cran.r-project.org/web/packages/magrittr/index.html}{package}
  (included with
...
\item
  ...
  to a \emph{function call} on the right-hand side (RHS). The following
  are equivalent:
\end{itemize}
