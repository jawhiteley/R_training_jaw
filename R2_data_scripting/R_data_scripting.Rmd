...
- All packages share an underlying design philosophy, grammar, and data structures.
  - _Unlike core $\R$_ <!-- and some other packages -->
...
- `dplyr` and `tidyr` provide many supporting functions that work _inside_ verbs 
  to make many common tasks easier to translate into code.
...
- [`lubridate`](https://lubridate.tidyverse.org/) and [`hms`](https://hms.tidyverse.org/): for dates & time values.
