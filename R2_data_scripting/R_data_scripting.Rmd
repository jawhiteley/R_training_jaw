...
+ defining your own functions
  - anonymous functions (or introduce when it becomes relevant, later)
-->
...
- The [`tidyverse`](https://www.tidyverse.org/) is actually an "opinionated" [collection of packages](https://www.tidyverse.org/packages/) that are designed to work together.

- All packages share an underlying design philosophy, grammar, and data structures.

Today, we will focus on a few of the core packages for loading, cleaning, and manipulating data:

* [tidyr](https://tidyr.tidyverse.org/)
* [dplyr](https://dplyr.tidyverse.org/)
* [readr](https://readr.tidyverse.org/), [readxl](https://readxl.tidyverse.org/)
...
- The [`magrittr`](https://magrittr.tidyverse.org/) [package](https://cran.r-project.org/web/packages/magrittr/index.html) (included with [`tidyverse`](https://www.tidyverse.org/packages/#program)) provides a "forward-pipe operator"<!--[^not-a-pipe]-->:
